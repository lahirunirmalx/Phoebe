/**
 * @file font5x8.cpp
 * @brief 5x8 ASCII font, column-major. Compact subset of the widely-used
 *        "Adafruit GFX glcdfont" / Code Page 437 5x7+1 baseline font --
 *        public domain. Covers 0x20..0x7E; everything else falls back to
 *        a blank glyph.
 */
#include "font5x8.h"
...
// Indexed by (ch - 0x20). Each entry is 5 bytes column-major.
