...
SERIAL_PORT=${SERIAL_PORT:-/dev/ttyUSB0}    # FNK0112 CH340 enumerates as ttyUSB*
DO_MONITOR=1
DO_NVS=1
...
# export.sh on this machine adds the s3 Xtensa toolchain but not the classic
# esp32 one even though it's installed -- re-add it if the compiler is missing.
